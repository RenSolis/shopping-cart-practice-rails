class InstrumentsController < ApplicationController
  before_action :set_instrument_without_authentication, only: :show
  before_action :set_instrument_with_authentication, only: %i[edit update destroy]
  ...
  private
    ...
    def set_instrument_without_authentication
      @instrument = Instrument.find(params[:id])
    end

    def set_instrument_with_authentication
